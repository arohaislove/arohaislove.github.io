/**
 * Talk Coastguard - Audio Learning Guide Generator
...
const CONFIG = {
    ...
    voices: {
        'calm-professional': {
            // Roger - professional and smooth, good for training material
...
async function combineAllAudio() {
    const sectionIds = [
        'intro', 'words-avoid', 'who-we-are', 'funding', 'daily-work',
        'education', 'fundraising', 'membership', 'sar', 'tools',
        'volunteers', 'te-reo-tips', 'kuputaka-greetings', 'kuputaka-common',
        'kuputaka-special', 'outro'
    ];
    const audioBlobs = [];
...
function downloadCombinedAudio() {
    ...
    downloadBlob(state.combinedAudioBlob, 'Talk-Coastguard-Audio-Guide.mp3');
}
...
function downloadSectionAudio(sectionId) {
    ...
    const filename = `Talk-Coastguard-${sectionId}.mp3`;
